    ...
    <section class="cart container mt-2 my-3 py-5">
                            ...
                            <div class="product-info">
                                ...
                                <div>
                                    ...
                                    <form method="POST" action="cart.php"> 
                                        ...
                                        <input type="submit" name="remove_btn" class="remove-btn" value="Elimină">
                                    </form>
                                </div>
                            </div>
                        </td>
        ...
        <div class="checkout-container">
            ...
            <form method = "GET" action="checkout.php" >
                <input type="submit" class="btn checkout-btn" value="Finalizează și Plătește" name="checkout_btn">
            </form>
    ...
    <div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        <div class="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            ...
            <div class="col-lg-5 col-md-6 mb-5">
                <h4 class="text-white text-uppercase mb-4" style="letter-spacing: 3px;">Urmarește-ne pe Social Media</h4>
